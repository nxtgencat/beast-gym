export default function CoachProfile() {
  return (
    <section className="relative py-16 lg:py-20 overflow-hidden">
      {/* background image layer — adjust opacity-XX below to taste */}
      <div
        className="absolute inset-0 bg-cover bg-center"
        style={{ backgroundImage: "url('/assets/cbg.png')" }}
      />
      {/* dark tint on top of the image — adjust bg-black/XX to control darkness */}
      <div className="absolute inset-0 bg-black/80" />
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-10 grid lg:grid-cols-2 gap-12 items-end">
        <img
          src="public/assets/john.png"
          className="w-40 h-40 lg:w-full lg:h-[560px] object-cover object-bottom mx-auto lg:mx-0 border-2 border-brand lg:border-0 self-end"
          alt="John Snow, body building coach"
        />
        <div className="text-center lg:text-left self-end">
          <h1 className="font-heading text-3xl sm:text-4xl lg:text-5xl font-bold uppercase text-white">John Snow</h1>
          <p className="text-white text-xs sm:text-sm font-bold tracking-[0.25em] uppercase mt-3">Body Building Coach</p>
          <dl className="mt-8 space-y-3 text-sm">
            <div className="flex gap-2 justify-center lg:justify-start">
              <dt className="font-bold uppercase tracking-widest text-white">Age:</dt>
              <dd className="text-white/80">29</dd>
            </div>
            <div className="flex gap-2 justify-center lg:justify-start">
              <dt className="font-bold uppercase tracking-widest text-white">Experience:</dt>
              <dd className="text-white/80">5 Years</dd>
            </div>
            <div className="flex gap-2 justify-center lg:justify-start">
              <dt className="font-bold uppercase tracking-widest text-white">Phone:</dt>
              <dd className="text-white/80">+1 9876543210</dd>
            </div>
            <div className="flex gap-2 justify-center lg:justify-start">
              <dt className="font-bold uppercase tracking-widest text-white">Email:</dt>
              <dd className="text-white/80">john@Beast.com</dd>
            </div>
          </dl>
          <div className="flex items-center gap-3 mt-8 justify-center lg:justify-start">
            <a href="#" className="w-9 h-9 border border-white/40 text-white flex items-center justify-center hover:bg-brand hover:border-brand hover:text-white transition">
